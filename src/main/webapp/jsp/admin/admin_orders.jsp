...
<body>
    <form method="GET" action="<c:url value="/controller"/>">
		...
		<p><input type="submit" value="view all order"></p>
	</form>
	<form method="GET" action="<c:url value="/controller"/>">
        <input type="hidden" name="command" value="unpaid_order">
		<input type="submit" value="unpaid order">
		<br>
	</form>
	<br>
	<form method="GET" action="<c:url value="/controller"/>">
        <input type="hidden" name="command" value="today_order">
		<input type="submit" value="today order">
	<br>
	</form>
	<br>
	<form method="GET" action="<c:url value="/controller"/>">
	...
	<c:forEach var="elem" items="${orders}" varStatus="status">
		...
		<form method="GET" action="<c:url value="/controller"/>">
			...
			<p><input type="submit" value="paid order"></p>
		</form>
		<form method="GET" action="<c:url value="/controller"/>">
